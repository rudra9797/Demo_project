                            ...
                            <div class="flex flex-row justify-between bg-white">
                                ...
                                <div class="flex flex-col w-2/5 border-r-2 overflow-y-auto">
                                    ...
                                    <div class="flex flex-row py-4 px-2 justify-center items-center border-b-2">
                                        <div class="w-1/4">
                                            <img src="https://source.unsplash.com/_7LbC5J-jw4/600x600" height="50"
                                    ...
                                    <div class="flex flex-row py-4 px-2 items-center border-b-2">
                                        <div class="w-1/4">
                                            <img src="https://source.unsplash.com/otT2199XwI8/600x600" height="50"
                                                class="object-cover h-12 w-12 rounded-full" alt="" />
                                        </div>
                                        <div class="w-full">
                                    ...
                                    <div class="flex flex-row py-4 px-2 items-center border-b-2 border-l-4 border-blue-400">
                                        <div class="w-1/4">
                                            <img src="https://source.unsplash.com/L2cxSuKWbpo/600x600" height="50"
                                                class="object-cover h-12 w-12 rounded-full" alt="" />
                                        </div>
                                        <div class="w-full">
                                    ...
                                    <div class="flex flex-row py-4 px-2 items-center border-b-2">
                                        <div class="w-1/4">
                                            <img src="https://source.unsplash.com/vpOeXr5wmR4/600x600" height="50"
                                                class="object-cover h-12 w-12 rounded-full" alt="" />
                                        </div>
                                        <div class="w-full">
